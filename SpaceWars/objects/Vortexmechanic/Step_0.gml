...
with (Phydest)
{
physics_apply_force(phy_com_x,phy_com_y,-(phy_com_x-other.x)*0.00001,-(phy_com_y-other.y)*0.00001)	
	if (phy_com_x*phy_com_x)+(phy_com_y*phy_com_y)>268435456 {HP-=0.01;}
